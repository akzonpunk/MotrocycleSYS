...
<html>
  <head>
    ...
    <title>motorcycle | www.jesuscristoitslife.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>Venta</b>Motorcycle</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>COORP-Motorcycle</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <small>jesucristo@gmail.com</small>
                    </p>
                  </li>
